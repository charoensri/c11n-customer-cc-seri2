...
import Customorg2ExtensionsMyForm1 from './index.jsx';
...
export default {
  title: 'Customorg2ExtensionsMyForm1',
  decorators: [withKnobs],
  component: Customorg2ExtensionsMyForm1
};
...
export const baseCustomorg2ExtensionsMyForm1 = () => {
  const props = {
    NumCols: 1,
  ...
  return (
    <>
      <Customorg2ExtensionsMyForm1 {...props}>{regionAChildren}</Customorg2ExtensionsMyForm1>
    </>
  );
};
